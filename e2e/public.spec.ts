...
test("save-the-date page accepts a reply and shows it in the admin list", async ({ page }) => {
  await page.goto("/");
  ...
  await expect(page.getByRole("cell", { name: "playwright@example.com" })).toBeVisible();
});
